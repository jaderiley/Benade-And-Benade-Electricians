...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Benade and Benade Electricians",
    phone:     "+27 82 062 3466",
    whatsapp:  "+27 82 062 3466",
    address:   "Roodepoort, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Benade and Benade Electricians — Electrician in roodepoort",
    description: "Benade and Benade Electricians provides professional electrician in Roodepoort. 8 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Electrician · Roodepoort & surrounds",
    heroTitle:  "Electrical faults, installations — <em>fixed properly.</em>",
    heroLead:   "Benade and Benade Electricians handles residential and commercial electrical work across Roodepoort. Fault-finding, DB board repairs, compliance certificates and new installations.",
    ...
    band: {
      ...
      alt:   "Benade and Benade Electricians team at work in Roodepoort",
      text:  "Professional electrical work — done right, first time."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Roodepoort. Serving the wider area.",
    areasLead:  "We work across Roodepoort, Florida, Weltevreden Park and the surrounding suburbs.",
    ...
    // ─── REVIEWS ───────────────────────────────────────────
    reviewsTitle: "From 8 verified Google reviews.",
    reviews: [
      {
